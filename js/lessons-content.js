const LESSONS_CONTENT = {
  ...
  'personal-pronouns': {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Ersetzen Sie (Akk): Ich sehe (der Hund) → Ich sehe ___.', answer: 'ihn', explain: 'der Hund (m) Akk → ihn.' },
      { type: 'fill', question: 'Dativ: Ich gebe ___ das Buch. (ему)', answer: 'ihm', explain: '«ему» = ihm.' },
      { type: 'translate', question: 'Исправь ошибку: «Hilf mich!»', answer: 'Hilf mir!', hint: 'helfen → Dativ: mir', placeholder: 'Hilf...', explain: 'helfen требует Dativ.' },
      { type: 'fill', question: 'Ersetzen Sie (Nom): die Idee → ___', answer: 'sie', explain: 'die Idee (f) → sie.' },
    ],
  },
  ...
  'n-deklination': {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Setzen Sie in den Akkusativ: Ich sehe den ___. (der Tourist)', answer: 'Touristen', explain: 'Слабое: +en → Touristen.' },
      { type: 'fill', question: 'Setzen Sie in den Dativ: Ich helfe dem ___. (der Kollege)', answer: 'Kollegen', explain: 'Слабое: +n → Kollegen.' },
      { type: 'translate', question: 'Исправь ошибку: «Ich kenne den Student.»', answer: 'Ich kenne den Studenten.', hint: 'слабое: den Studenten', placeholder: 'Ich kenne...', explain: 'N-Deklination: +en в Akk.' },
      { type: 'fill', question: 'Особое слово: Ich sehe den ___. (der Herr)', answer: 'Herrn', explain: 'der Herr → Herrn (Sg).' },
    ],
  },
  ...
  plural: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Bilden Sie den Plural: der Tag → die ___', answer: 'Tage', explain: 'Мужской → -e: Tage.' },
      { type: 'fill', question: 'Bilden Sie den Plural: das Kind → die ___', answer: 'Kinder', explain: '-er: Kinder.' },
      { type: 'fill', question: 'Bilden Sie den Plural: die Lösung → die ___', answer: 'Lösungen|Loesungen', explain: 'Женский → -en.' },
      { type: 'fill', question: 'Dativ Plural: mit den ___ (die Freunde)', answer: 'Freunden', explain: 'Dativ Pl +n: Freunden.' },
    ],
  },
  ...
  mischverben: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Präteritum: denken → ich ___', answer: 'dachte', explain: 'denken → dachte.' },
      { type: 'fill', question: 'Partizip II: bringen → ___', answer: 'gebracht', explain: 'bringen → gebracht.' },
      { type: 'fill', question: 'Präsens: ich ___ die Antwort. (wissen)', answer: 'weiß|weiss', explain: 'wissen → ich weiß.' },
      { type: 'translate', question: 'kennen или wissen: Я знаю, где он живёт.', answer: 'Ich weiß, wo er wohnt.', hint: 'факт → wissen', placeholder: 'Ich weiß...', explain: 'Знание факта → wissen.' },
    ],
  },
  ...
  nominativ: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Ergänzen Sie (Nom): ___ Antrag liegt schon vor. (der Antrag)', answer: 'der', explain: 'Подлежащее m → der.' },
      { type: 'fill', question: 'Nach sein → Nom: Das ist ___ kluge Idee. (die Idee)', answer: 'eine', explain: 'После sein Nominativ; f → eine.' },
      { type: 'translate', question: 'Исправь ошибку: «Das ist den Chef.»', answer: 'Das ist der Chef.', hint: 'после ist → Nominativ', placeholder: 'Das ist...', explain: 'После sein именная часть в Nominativ.' },
      { type: 'fill', question: 'Найди подлежащее (Nom): «Den Brief schreibt ___ Sekretärin.» (die Sekretärin)', answer: 'die', explain: 'Подлежащее f → die, даже после глагола.' },
    ],
  },
  ...
  negation: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'kein или nicht: Ich habe ___ Geld. (das Geld)', answer: 'kein', explain: 'Существительное без артикля → kein.' },
      { type: 'fill', question: 'kein или nicht: Ich verstehe die Frage ___.', answer: 'nicht', explain: 'Опр. артикль → nicht.' },
      { type: 'translate', question: 'Verneinen Sie: Ich habe einen Plan. (отрицание)', answer: 'Ich habe keinen Plan.', hint: 'einen → keinen', placeholder: 'Ich habe...', explain: 'ein → kein.' },
      { type: 'translate', question: 'Исправь ошибку: «Das ist nicht ein Problem.»', answer: 'Das ist kein Problem.', hint: 'существительное с ein → kein', placeholder: 'Das ist...', explain: 'Отрицание существительного → kein.' },
    ],
  },
  ...
  'sentence-order': {
    ...
    exercises: [
      ...
      { type: 'translate', question: 'Начни с «Heute»: Я работаю дома. (im Homeoffice arbeiten)', answer: 'Heute arbeite ich im Homeoffice.', hint: 'Heute + глагол + ich', placeholder: 'Heute...', explain: 'Инверсия: глагол на 2-м месте.' },
      { type: 'translate', question: 'Исправь ошибку: «Morgen ich fahre nach Wien.»', answer: 'Morgen fahre ich nach Wien.', hint: 'инверсия после Morgen', placeholder: 'Morgen...', explain: 'После обстоятельства глагол → подлежащее.' },
      { type: 'translate', question: 'Рамка (Perfekt): Я купил книгу. (kaufen, das Buch)', answer: 'Ich habe ein Buch gekauft.', hint: 'habe … gekauft (в конец)', placeholder: 'Ich habe...', explain: 'Partizip в конце.' },
      { type: 'translate', question: 'Вопрос: Где ты живёшь? (wohnen)', answer: 'Wo wohnst du?', hint: 'Wo + глагол на 2-м', placeholder: 'Wo...', explain: 'W-вопрос: глагол второй.' },
    ],
  },
  ...
  'verben-praepositionen': {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Ergänzen Sie die Präposition: Ich warte ___ den Bus.', answer: 'auf', explain: 'warten auf.' },
      { type: 'fill', question: 'Ergänzen Sie: Ich denke oft ___ dich.', answer: 'an', explain: 'denken an.' },
      { type: 'fill', question: 'da(r)-Form: — Denkst du an die Prüfung? — Ja, ich denke ___.', answer: 'daran', explain: 'an → daran.' },
      { type: 'translate', question: 'Исправь ошибку: «Ich interessiere mich über Musik.»', answer: 'Ich interessiere mich für Musik.', hint: 'sich interessieren für', placeholder: 'Ich interessiere mich...', explain: 'Правильный предлог — für.' },
    ],
  },
  ...
  'prepositions-place': {
    ...
    level: 'A2 · Урок 20',
    intro: 'Wechselpräpositionen — «двойные» предлоги: то Dativ, то Akkusativ. Разберём правило Wo?/Wohin?, тонкости an/auf/in, направление (zu/nach/in), парные глаголы legen/liegen и частые ошибки. В упражнениях ты сама пишешь ответы — как в рабочей тетради.',
    theory: [
      {
        heading: '📍 9 «двойных» предлогов (Wechselpräpositionen)',
        content: `
          <p>Девять предлогов могут управлять <b>и Dativ, и Akkusativ</b>. Выучи их как считалку — это половина успеха:</p>
          <div class="table-wrap"><table>
            ...
            <tr><td><b>an</b></td><td>на (вертик.), у, при, к</td><td>Das Bild hängt <b>an der</b> Wand.</td></tr>
            <tr><td><b>auf</b></td><td>на (горизонт., сверху)</td><td>Das Buch liegt <b>auf dem</b> Tisch.</td></tr>
            <tr><td><b>über</b></td><td>над; через</td><td>Die Lampe hängt <b>über dem</b> Tisch.</td></tr>
            <tr><td><b>unter</b></td><td>под; среди</td><td>Die Katze schläft <b>unter dem</b> Bett.</td></tr>
            <tr><td><b>vor</b></td><td>перед; (о времени) назад</td><td>Das Auto steht <b>vor dem</b> Haus.</td></tr>
          ...
          <div class="example-box">
            <div class="de">💡 Это единственные предлоги с «плавающим» падежом. Для сравнения: <b>bei, gegenüber, aus, mit, nach, zu, von, seit</b> — всегда Dativ; <b>durch, für, gegen, ohne, um</b> — всегда Akkusativ.</div>
      ...
      },
      {
        ...
        content: `
          <p>Падеж зависит <b>не от предлога</b>, а от смысла фразы:</p>
          <ul>
            <li><b>Wo?</b> (где?) — предмет <u>находится</u>, нет движения к цели → <b>Dativ</b></li>
            <li><b>Wohin?</b> (куда?) — есть <u>движение в сторону</u> цели → <b>Akkusativ</b></li>
          </ul>
          <p>Одна фраза — два смысла:</p>
          <div class="example-box">
          ...
          <div class="table-wrap"><table>
            ...
            <tr><td>die (Pl)</td><td><b>den</b> (сущ. +n!)</td><td><b>die</b></td></tr>
          </table></div>
          <div class="example-box">
            <div class="de">Plural Dativ: zwischen <b>den Stühlen</b>, auf <b>den Tischen</b> — существительное получает -n.</div>
            <div class="ru">В Dativ Plural к существительному добавляется -n (если его ещё нет).</div>
          </div>
          <p>⚠️ Не путай с вопросом <b>Woher?</b> (откуда?) — он идёт с другими предлогами (aus, von) и всегда Dativ: <i>Ich komme <b>aus der</b> Schule.</i></p>
        `
      },
      {
        heading: '🎯 Тонкость: an / auf / in — когда какой?',
        content: `
          <p>Это самая частая путаница. Разница в том, <b>как</b> предмет соприкасается с поверхностью:</p>
          <div class="table-wrap"><table>
            <tr><th>Предлог</th><th>Идея</th><th>Примеры</th></tr>
            <tr><td><b>an</b></td><td>контакт с вертикальной поверхностью, краем или границей</td><td>an der Wand (на стене), am Fenster (у окна), an der Tür (на двери), am See (у озера), am Tisch sitzen (сидеть за столом)</td></tr>
            <tr><td><b>auf</b></td><td>сверху на горизонтальной поверхности</td><td>auf dem Tisch (на столе), auf dem Boden (на полу), auf dem Dach (на крыше)</td></tr>
            <tr><td><b>in</b></td><td>внутри, в закрытом пространстве</td><td>in der Tasche (в сумке), im Zimmer (в комнате), im Wasser (в воде)</td></tr>
          </table></div>
          <div class="example-box">
            <div class="de">Das Poster hängt <b>an der</b> Wand. · Das Buch liegt <b>auf dem</b> Tisch. · Die Socken sind <b>in der</b> Schublade.</div>
            <div class="ru">Постер висит на стене. · Книга лежит на столе. · Носки в ящике.</div>
          </div>
          <p>Особый случай — <b>учреждения и места</b>, тут немцы говорят не всегда логично, надо запомнить:</p>
          <ul>
            <li><b>in</b>: in der Schule, im Kino, im Theater, im Büro, in der Stadt</li>
            <li><b>auf</b>: auf der Post, auf der Bank, auf dem Markt, auf dem Land (за городом)</li>
            <li><b>an</b>: an der Uni(versität), an der Kasse</li>
          </ul>
        `
      },
      {
        ...
        content: `
          <p>У каждого «положения» два глагола: один — <b>действие/движение</b> (Akkusativ, Wohin?), другой — <b>состояние</b> (Dativ, Wo?).</p>
          <div class="table-wrap"><table>
            ...
            <tr><td><b>hängen</b> (слаб.: hängte) — вешать</td><td><b>hängen</b> (сильн.: hing) — висеть</td></tr>
            <tr><td><b>stecken</b> — засовывать</td><td><b>stecken</b> — торчать / быть внутри</td></tr>
          </table></div>
          <div class="example-box">
            <div class="de">Ich <b>stelle</b> die Vase auf <b>den</b> Tisch. (Wohin? — Akk)<br>Die Vase <b>steht</b> auf <b>dem</b> Tisch. (Wo? — Dativ)</div>
            <div class="ru">Я ставлю вазу на стол. / Ваза стоит на столе.</div>
          </div>
          <p>Подсказка: глаголы движения (legen, stellen, setzen) — <b>переходные</b>, у них есть прямой объект «что?» (Akkusativ). Глаголы состояния (liegen, stehen, sitzen) описывают, где предмет уже находится.</p>
          <p>В Perfekt: <i>Ich habe das Buch auf den Tisch <b>gelegt</b>. / Das Buch hat auf dem Tisch <b>gelegen</b>.</i></p>
        `
      },
      {
        heading: '🚶 Направление: in/auf/an + Akk · zu · nach',
        content: `
          <p>Когда говорим «куда идём/едем», есть три способа, и они не взаимозаменяемы:</p>
          <div class="table-wrap"><table>
            <tr><th>Как</th><th>Когда</th><th>Пример</th></tr>
            <tr><td><b>in/auf/an + Akk</b></td><td>входим внутрь / на территорию</td><td>Ich gehe <b>in die</b> Schule. Ich gehe <b>auf die</b> Post.</td></tr>
            <tr><td><b>zu + Dativ</b></td><td>к человеку или к месту (направление)</td><td>Ich gehe <b>zum</b> Arzt. Ich fahre <b>zur</b> Bank.</td></tr>
            <tr><td><b>nach</b></td><td>города и страны без артикля; nach Hause</td><td>Ich fahre <b>nach</b> Wien. Ich gehe <b>nach</b> Hause.</td></tr>
          </table></div>
          <div class="example-box">
            <div class="de">zu Hause = дома (Wo?) · nach Hause = домой (Wohin?)</div>
            <div class="ru">Ich bin zu Hause. (я дома) — Ich gehe nach Hause. (иду домой)</div>
          </div>
          <p>Запомни слияния: <b>zu + dem = zum</b>, <b>zu + der = zur</b>.</p>
        `
      },
      {
        heading: '🔗 Слияния и частые ошибки',
        content: `
          <p>Предлог часто сливается с артиклем — узнавай их:</p>
          <div class="table-wrap"><table>
          ...
          <p><b>Топ ошибок:</b></p>
          <ul>
            <li>«иду куда-то» (ins, Akk) ↔ «нахожусь где-то» (im, Dativ). Всегда спроси: Wo? или Wohin?</li>
            <li>Забыть -n в Dativ Plural: <i>zwischen den Häuser<b>n</b></i>, а не «Häuser».</li>
            <li>liegen/legen, stehen/stellen — глагол состояния путают с глаголом действия.</li>
            <li>«nach» только для городов/стран без артикля. С артиклем — in: <i>in <b>die</b> Schweiz</i> (а не «nach»).</li>
          </ul>
        `
      }
    ],
    exercises: [
      { type: 'fill', question: 'Das Buch liegt auf ___ Tisch. (Wo? · der Tisch)', answer: 'dem', placeholder: 'd...' },
      { type: 'fill', question: 'Ich lege das Buch auf ___ Tisch. (Wohin? · der Tisch)', answer: 'den', placeholder: 'd...' },
      ...
      { type: 'fill', question: 'Die Kinder spielen in ___ Garten. (Wo? · der Garten)', answer: 'dem', placeholder: 'd...' },
      { type: 'fill', question: 'Die Tassen stehen zwischen ___ Tellern. (Wo? · Plural die Teller)', answer: 'den', placeholder: 'd...' },
      { type: 'fill', question: 'Слияние: Ich gehe ___ Kino. (in + das)', answer: 'ins', placeholder: '...' },
      { type: 'fill', question: 'Слияние: Ich bin ___ Kino. (in + dem)', answer: 'im', placeholder: '...' },
      { type: 'fill', question: 'Глагол состояния: Die Katze ___ auf dem Sofa. (liegen/legen)', answer: 'liegt', placeholder: 'li...' },
      { type: 'fill', question: 'Глагол действия: Ich ___ die Vase auf den Tisch. (stellen/stehen)', answer: 'stelle', placeholder: 'st...' },
      { type: 'fill', question: 'Направление к человеку: Ich gehe ___ Arzt. (zu + dem = ?)', answer: 'zum', placeholder: 'z...' },
      ...
      { type: 'translate', question: 'Лампа висит над столом.', answer: 'Die Lampe hängt über dem Tisch.', hint: 'hängen (висеть) + Wo? → Dativ', placeholder: 'Die Lampe...' },
      { type: 'translate', question: 'Я еду в Вену.', answer: 'Ich fahre nach Wien.', hint: 'город без артикля → nach', placeholder: 'Ich fahre...' },
      { type: 'translate', question: 'Я иду домой.', answer: 'Ich gehe nach Hause.', hint: 'домой = nach Hause', placeholder: 'Ich gehe...' },
      { type: 'listen', answer: 'Der Stuhl steht vor dem Fenster.', hint: '5 слов · vor + Dativ' },
      { type: 'listen', answer: 'Ich hänge das Bild an die Wand.', hint: 'Wohin? · an + Akkusativ' },
      { type: 'reading',
        text: 'Das ist mein Zimmer. In der Mitte steht ein Bett. Neben dem Bett steht ein kleiner Tisch, und auf dem Tisch liegt mein Handy. An der Wand hängt ein großes Bild. Unter dem Bett schläft meine Katze. Vor dem Fenster steht ein Stuhl, und hinter der Tür steht ein Schrank.',
        translation: 'Это моя комната. Посередине стоит кровать. Рядом с кроватью стоит маленький стол, а на столе лежит мой телефон. На стене висит большая картина. Под кроватью спит моя кошка. Перед окном стоит стул, а за дверью стоит шкаф.',
        questions: [
          { q: 'Wo liegt das Handy? (3 слова: auf + Dativ)', answer: 'auf dem Tisch' },
          { q: 'Wo schläft die Katze? (3 слова: unter + Dativ)', answer: 'unter dem Bett' },
          { q: 'Was steht vor dem Fenster? (1–2 слова)', answer: 'ein Stuhl|Stuhl|der Stuhl' }
        ]
      },
      { type: 'write', question: 'Beschreibe dein Zimmer: Wo stehen und liegen die Sachen? Schreib 4–6 Sätze (Wo? → Dativ).', hint: 'Глаголы состояния: stehen, liegen, hängen. Предлоги: in, auf, an, neben, unter, vor, hinter + Dativ.', placeholder: 'In meinem Zimmer...', sample: 'In meinem Zimmer steht ein Bett. Neben dem Bett steht ein Tisch. Auf dem Tisch liegen meine Bücher. An der Wand hängt ein Bild. Unter dem Fenster steht ein Stuhl.' },
      { type: 'write', question: 'Wohin gehst du heute? Schreib 3–4 Sätze über deine Wege (Wohin? → in/auf/zu/nach).', hint: 'Ich gehe in die … / auf die … / zum … / nach … Используй движение (Akkusativ или zu/nach).', placeholder: 'Heute gehe ich...', sample: 'Heute gehe ich in die Schule. Danach fahre ich zum Arzt. Am Abend gehe ich auf die Post und dann nach Hause.' }
    ],
  },
  ...
  'subordinate-clauses': {
    ...
    exercises: [
      ...
      { type: 'translate', question: 'Соедини в одно (weil): Ich bleibe zu Hause. Ich bin krank.', answer: 'Ich bleibe zu Hause, weil ich krank bin.', hint: 'weil → bin в конец', placeholder: 'Ich bleibe zu Hause, weil...', explain: 'weil отправляет глагол в конец.' },
      { type: 'translate', question: 'Соедини (dass): Ich hoffe. Du kommst morgen.', answer: 'Ich hoffe, dass du morgen kommst.', hint: 'dass → kommst в конец', placeholder: 'Ich hoffe, dass...', explain: 'dass → глагол в конец.' },
      { type: 'fill', question: 'als или wenn: ___ ich Kind war, wohnte ich in Moskau.', answer: 'Als', explain: 'Однократно в прошлом → als.' },
      { type: 'translate', question: 'Исправь ошибку: «Ich denke, dass er ist müde.»', answer: 'Ich denke, dass er müde ist.', hint: 'dass → ist в конец', placeholder: 'Ich denke, dass...', explain: 'В придаточном глагол в конце.' },
    ],
  },
  ...
  'trennbare-verben': {
    ...
    exercises: [
      ...
      { type: 'translate', question: 'Раскрой скобки (Präsens): Ich (anrufen) dich morgen.', answer: 'Ich rufe dich morgen an.', hint: 'rufe … an', placeholder: 'Ich rufe...', explain: 'Отделяемая приставка в конец.' },
      { type: 'fill', question: 'Раскрой скобки: Wann (aufstehen) ___ du? — спрягаемая часть', answer: 'stehst', explain: 'stehst … auf.' },
      { type: 'fill', question: 'Partizip: einkaufen → ___', answer: 'eingekauft', explain: 'ge- внутрь: eingekauft.' },
      { type: 'translate', question: 'Исправь ошибку: «Ich anrufe meinen Chef.»', answer: 'Ich rufe meinen Chef an.', hint: 'rufe … an', placeholder: 'Ich rufe...', explain: 'Приставка отделяется в конец.' },
    ],
  },
    ...
    theory: [
      {
        ...
        content: `
          ...
          <div class="table-wrap"><table>
            ...
            <tr><td>Dat</td><td>dem gut<b>en</b></td><td>der gut<b>en</b></td><td>dem gut<b>en</b></td><td>den gut<b>en</b></td></tr>
    ...
    theory: [
      {
        ...
        content: `
          ...
          <div class="table-wrap"><table>
            ...
            <tr><td>Akk</td><td>einen gut<b>en</b></td><td>eine gut<b>e</b></td><td>ein gut<b>es</b></td></tr>
  ...
  komparativ: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Bilden Sie Komparativ: schnell → ___', answer: 'schneller', explain: '+er.' },
      { type: 'fill', question: 'Bilden Sie Komparativ: groß → ___', answer: 'größer|groesser', explain: 'Умлаут: größer.' },
      { type: 'translate', question: 'Исправь ошибку: «Wien ist kleiner wie Berlin.»', answer: 'Wien ist kleiner als Berlin.', hint: 'сравнение → als', placeholder: 'Wien ist kleiner...', explain: 'После сравнительной — als, не wie.' },
      { type: 'fill', question: 'Superlativ: gut → am ___', answer: 'besten', explain: 'Исключение: am besten.' },
    ],
  },
  ...
  praeteritum: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Präteritum: sein → er ___', answer: 'war', explain: 'sein → war.' },
      { type: 'fill', question: 'Präteritum: haben → ich ___', answer: 'hatte', explain: 'haben → hatte.' },
      { type: 'fill', question: 'Präteritum (слабый): machen → er ___', answer: 'machte', explain: 'Слабый: -te.' },
      { type: 'translate', question: 'Поставь в Präteritum: Он пришёл поздно. (kommen)', answer: 'Er kam spät.', hint: 'kommen → kam', placeholder: 'Er kam...', explain: 'Сильный глагол: kam.' },
    ],
  },
  ...
  'reflexive-verbs': {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Ergänzen Sie das Reflexivpronomen: Ich freue ___.', answer: 'mich', explain: 'ich → mich.' },
      { type: 'fill', question: 'Ergänzen Sie: Wir treffen ___ um acht.', answer: 'uns', explain: 'wir → uns.' },
      { type: 'fill', question: 'Dativ-вариант: Ich wasche ___ die Hände.', answer: 'mir', explain: 'есть объект → Dativ mir.' },
      { type: 'translate', question: 'Исправь ошибку: «Er freut mich auf den Urlaub.»', answer: 'Er freut sich auf den Urlaub.', hint: '3-е лицо → sich', placeholder: 'Er freut sich...', explain: 'er → sich.' },
    ],
  },
  ...
  relativsatz: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Relativpronomen (Nom m): Der Mann, ___ dort steht, … ', answer: 'der', explain: 'Подлежащее m → der.' },
      { type: 'fill', question: 'Relativpronomen (Akk n): Das Buch, ___ ich kaufe, … ', answer: 'das', explain: 'Объект n → das.' },
      { type: 'fill', question: 'Relativpronomen (Dativ m): Der Kunde, ___ ich helfe, …', answer: 'dem', explain: 'helfen → Dativ, m → dem.' },
      { type: 'translate', question: 'Образуй: женщина, которую я знаю (die Frau, kennen)', answer: 'die Frau, die ich kenne', hint: 'Akk f → die', placeholder: 'die Frau, die...', explain: 'Akkusativ женского → die.' },
    ],
  },
  ...
  possessivpron: {
    ...
    exercises: [
      ...
      { type: 'fill', question: 'Ergänzen Sie (Nom m): Das ist ___ Bruder. (мой)', answer: 'mein', explain: 'Nom m → mein.' },
      { type: 'fill', question: 'Ergänzen Sie (Akk m): Ich rufe ___ Chef an. (мой)', answer: 'meinen', explain: 'Akk m → meinen.' },
      { type: 'fill', question: '«её» (Nom m): Anna und ___ Hund. ', answer: 'ihr', explain: 'Владелец Anna → ihr.' },
      { type: 'translate', question: 'Исправь ошибку: «Ich liebe mein Schwester.»', answer: 'Ich liebe meine Schwester.', hint: 'Akk f → meine', placeholder: 'Ich liebe...', explain: 'Schwester женский → meine.' },
    ],
  },
